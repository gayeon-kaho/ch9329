...
# Function to execute different tasks based on keyboard input
    ...
    while not exit_signal.is_set():
        try:
            if keyboard.is_pressed('r'):
                ...
                time.sleep(0.01)  # Add a short delay to avoid rapid execution of def extract_cdnt
            elif keyboard.is_pressed('l'):
                print("Function 'Left click' executed")
                drv.click(CH9329.L_BTN)
                time.sleep(0.01)  # time.sleep can cause drag function according to the thread's time slice
